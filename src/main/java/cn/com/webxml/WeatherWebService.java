 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/D:/accumulation/git/learintJpaQdsl/WeatherWebService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/accumulation/git/learintJpaQdsl/WeatherWebService.wsdl");
