...
public final class CreateSimpleForm
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        try (PDDocument document = new PDDocument())
        {
            ...
            //PDRectangle rect = new PDRectangle(50, 20 %, 200, 50);
            COSArray cosBases = new COSArray();
            COSString cosString = new COSString("test1");
            cosBases.add(cosString);
            PDRectangle rect = new PDRectangle(cosBases);
